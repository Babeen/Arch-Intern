...
const QuickViewModal = ({ product, onClose }) => {
  ...
  return (
    // AnimatePresence is handled by the PARENT (ProductCard).
    // This component just defines its own enter animation.
    ...
    >
      ...
      {/* ── Modal Card ──────────────────────────────────────────────────────
          e.stopPropagation() prevents clicks inside the card from
          reaching the backdrop's onClick handler above.
          relative z-10 lifts it above the backdrop div.
      */}
      <motion.div
      ...
      >
        {/* Close button — absolute positioned to top-right corner of the card */}
        <button
          onClick={onClose}
        ...
        <div className="grid sm:grid-cols-2 gap-0">
          ...
          <div className="p-6 flex flex-col gap-4">
            ...
            {/* ── Action Buttons ─────────────────────────────────────────────
                Add to Cart: shows "Added!" briefly after clicking.
                View Details: navigates to the full product page.
            */}
